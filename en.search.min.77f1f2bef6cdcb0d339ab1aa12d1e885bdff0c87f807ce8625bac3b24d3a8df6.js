...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.477234893ecfaabb63a19957e1b5e6944ccebde01ffb285bb7e8b8376a7aaac9.js',function(){input.required=false;search();});}
