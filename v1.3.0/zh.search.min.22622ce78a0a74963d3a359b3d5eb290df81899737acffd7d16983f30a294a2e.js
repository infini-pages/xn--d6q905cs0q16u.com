...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/v1.3.0/flexsearch.min.js');loadScript('/v1.3.0/zh.search-data.min.f08f0a21003f2e29b47f3b7e53610790881e3ad873fbb0d0e8885a56db89b1eb.js',function(){input.required=false;search();});}
