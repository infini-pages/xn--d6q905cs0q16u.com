...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/v1.3.0/flexsearch.min.js');loadScript('/v1.3.0/zh.search-data.min.ed20264b2ca772243b8ead0ed31e98233dc18799ec3b7fbecbee1bad896ebf4d.js',function(){input.required=false;search();});}
