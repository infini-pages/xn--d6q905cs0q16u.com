...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/v1.3.0/flexsearch.min.js');loadScript('/v1.3.0/zh.search-data.min.b03683ed5df2626093c1680ea0ff72ead558c378e862b5e74e24b0acc2e200de.js',function(){input.required=false;search();});}
