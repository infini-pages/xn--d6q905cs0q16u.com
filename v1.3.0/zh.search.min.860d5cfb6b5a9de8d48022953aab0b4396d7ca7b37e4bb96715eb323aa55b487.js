...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/v1.3.0/flexsearch.min.js');loadScript('/v1.3.0/zh.search-data.min.91495bb85316a681ecf7ff2b3b692dfa1b4dbab9a1891119c66835d24330e60f.js',function(){input.required=false;search();});}
