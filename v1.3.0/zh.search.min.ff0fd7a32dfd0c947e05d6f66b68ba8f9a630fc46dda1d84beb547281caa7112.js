...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/v1.3.0/flexsearch.min.js');loadScript('/v1.3.0/zh.search-data.min.678d32400c44515bb65df53995c389f00289f6348ed0680aac65d910e9369a9f.js',function(){input.required=false;search();});}
