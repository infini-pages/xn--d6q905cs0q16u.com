...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/v1.4.0/flexsearch.min.js');loadScript('/v1.4.0/zh.search-data.min.c1975efe40301afd78d6579d433e2cdf08d1e7191195a3ca53f4c307397f5b69.js',function(){input.required=false;search();});}
