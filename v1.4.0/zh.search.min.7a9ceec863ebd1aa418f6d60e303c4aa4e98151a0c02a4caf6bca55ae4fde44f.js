...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/v1.4.0/flexsearch.min.js');loadScript('/v1.4.0/zh.search-data.min.4746cebf59d35c2721bf576fb39156920f85a1a743f0c2569c6d1d8a29002a58.js',function(){input.required=false;search();});}
