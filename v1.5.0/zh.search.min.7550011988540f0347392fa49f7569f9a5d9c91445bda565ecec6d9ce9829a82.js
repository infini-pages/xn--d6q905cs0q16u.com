...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/v1.5.0/flexsearch.min.js');loadScript('/v1.5.0/zh.search-data.min.1471f6ebad615e3203ac976e770662d0141a1290c0e560f4834a3edcaf45439b.js',function(){input.required=false;search();});}
