...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.7f23b32f69e7aac09a079bd2007a28bfcc7254220052d7df047a4ee04cab76be.js',function(){input.required=false;search();});}
