...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.f019cc9ad7fb2e0265ee8fe10db500b344c6b378ec11f2cb8291c176cd79e8c1.js',function(){input.required=false;search();});}
