...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.8670319dabd2baecb5b6418047762f96adff9de248327867a1246ea8b4b9e25d.js',function(){input.required=false;search();});}
