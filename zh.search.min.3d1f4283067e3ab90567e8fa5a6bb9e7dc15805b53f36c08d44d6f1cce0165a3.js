...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.5cd77a8dea22acee5b91387493ffb19b3813602a5a738084eb7d5327bbb1916c.js',function(){input.required=false;search();});}
