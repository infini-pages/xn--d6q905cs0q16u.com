...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.42ec07f6c21ccb2a40a0d1c070db36c018a9dcd369b21182d8f969ef9cf02a3c.js',function(){input.required=false;search();});}
