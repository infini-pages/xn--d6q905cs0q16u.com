...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.fa8af2db64dd4769944564a19da7d91bc00148eaaff973bf7cbaea4e61d1bebc.js',function(){input.required=false;search();});}
