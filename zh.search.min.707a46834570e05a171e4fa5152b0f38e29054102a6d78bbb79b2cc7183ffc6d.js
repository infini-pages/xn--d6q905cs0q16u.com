...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.8e0d040bf9ebba1355bd287cbee9c6d37c0455904200a22bd6ef1fe8f69ff04e.js',function(){input.required=false;search();});}
