...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.055c763da695d0a8c1211c19560c41f22aaf370f59edd03678e92b7ff94bdf1e.js',function(){input.required=false;search();});}
