...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.7970a8ef609dc00aef8eb0952e79575306a568ba9f9658932dae691a2a08a71c.js',function(){input.required=false;search();});}
