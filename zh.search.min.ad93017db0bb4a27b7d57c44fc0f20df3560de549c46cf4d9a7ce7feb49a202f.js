...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.c592ae4dd530b869a692c308458a75332858ef7bdad400a7afa563cf47dcc000.js',function(){input.required=false;search();});}
