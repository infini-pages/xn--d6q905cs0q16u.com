...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.e2f1661010fa565c4220badd963f1eb05b69673077ea5033db388e57aea7bca4.js',function(){input.required=false;search();});}
